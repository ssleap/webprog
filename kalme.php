                                    ...
                                    <article>
                                        <div class="list-single-main-media fl-wrap">
                                            <div class="single-slider-wrapper fl-wrap">
                                                <div class="single-slider fl-wrap">
                                                    <div class="slick-slide-item"><img src="images/all/칼메1.jpg" alt=""></div>
                                        ...
                                        <div class="list-single-main-item fl-wrap">
                                            <div class="list-single-main-item-title fl-wrap">
                                                <h3>시립대 정문 한정식, 백반집</h3>
                                            </div>
                                            <p>
                                                메인 메뉴는 제육쌈밥, 제육비빔밥, 불고기비빔밥
                                            </p>
                                            <p>
                                                한정식 백반과 함께 곁들어먹을 수 있는 냉모밀도 팜.
                                            </p>
                                            <p>
                                                가격이 저렴해서 학생들이 많이 찾음.
                                            </p>
                                            <blockquote>
                                                <p>긴 휴식기를 갖고 재영업시작함.</p>
                                            </blockquote>
                                            <p>시립대 정문 가성비 밥집</p>
                                    ...
                                    <div class="box-widget-item fl-wrap">
                                        ...
                                        <div class="box-widget list-author-widget">
                                            <div class="list-author-widget-header shapes-bg-small  color-bg fl-wrap">
                                                <span class="list-author-widget-link"><a href="author-single.html">칼리 앤 메리의 부엌</a></span>
                                                <img src="images/all/칼메.jpg" alt="">
